...
The default implementation of the NER wire contract (``elide_bento_core.ner.v1``). A
...
from elide_bento_core.ner.v1 import NerRequest, NerResponse
...
image = bentoml.images.Image(python_version="3.12", lock_python_packages=False).requirements_file(
    "packages/elide-bento-ner/requirements.txt"
)


@bentoml.service(
    name="elide-bento-ner",
    image=image,
