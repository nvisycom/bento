...
published as `ghcr.io/nvisycom/elide-bento-ner`.
...
scores. Request/response types come from [`elide_bento_core.ner.v1`](../elide-bento-core);
the generated contract lives at
[`elide_bento_core.ner.v1`](../elide-bento-core/src/elide_bento_core/ner/v1).
