...
- :mod:`elide_bento_core.ocr` — OCR request/response (``Page → Block → Line → Word``).
- :mod:`elide_bento_core.ner` — NER request/response (entities with model-native
...
from elide_bento_core import ner, ocr
