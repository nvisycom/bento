...
The default implementation of the OCR wire contract (``elide_bento_core.ocr.v1``).
...
from elide_bento_core.ocr.v1 import (
    Block,
    BlockKind,
    BoundingBox,
    Line,
...
image = (
    ...
    .requirements_file("packages/elide-bento-ocr/requirements.txt")
)


@bentoml.service(
    name="elide-bento-ocr",
    image=image,
    resources={"cpu": "2"},
    traffic={"timeout": 60},
