...
VLM read. Implements the ``elide_bento_core.ocrvl.v1`` contract.
...
from elide_bento_core.ocrvl.v1 import Region, VlRequest, VlResponse
from elide_bento_core.runtime import get_logger, request_id, resolve_model
...
image = (
    ...
    .requirements_file("packages/elide-bento-vl/requirements.txt")
)
...
def _regions_from_result(result) -> list[Region]:
    ...
    """
    from elide_bento_core.ocr.v1 import BoundingBox
